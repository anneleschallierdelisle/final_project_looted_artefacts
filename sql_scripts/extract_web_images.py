...
INPUT_PATH = BASE_DIR / "data" / "clean" / "weblink_text.csv"
OUTPUT_DIR = BASE_DIR / "figures" / "web_photos"
OUTPUT_CSV = BASE_DIR / "data" / "clean" / "web_photos_manifest.csv"
...
def main():
    ...
    print(f"Pages à traiter: {len(work_df)}")
    ...
    with sync_playwright() as p:
        ...
        for _, row in tqdm(work_df.iterrows(), total=len(work_df)):
            ...
            page_url = str(row["lien_ok"]).strip()
